...
+F5::
paste_message_in_chat_and_submit("/me", "прохлопал верхние и нижние слои одежд")
paste_message_in_chat_and_submit("/me", "нашел кошелек и взял в рук")
paste_message_in_chat_and_submit("/do", "Кошелек в руке")
paste_message_in_chat_and_submit("/me", "достал из кошелька деньги затем выкинул его на землю")
Return
...
build_gui_2() {
    ...
    add_text_to_gui(2, 10, 800, [[["cWhite","Фарм BP", "U"]]
                                 ...
                                 ,[["cWhite","- Сдача контрабанды на 13.000$ 2/4 BP"]]
                                 ...
                                 ,[["cWhite","- Выкопать 1 сокровище(не мусор) 1/2 BP"]]])
