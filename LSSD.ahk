...
toggle_gui(show_gui) {
    ...
    If show_gui {
        ...
        add_text_to_gui(800, 1000, [[["cWhite","Вы имеете право хранить молчание. Всё, что вы скажете, может и будет использовано против Вас."]]
        ...
        add_text_to_gui(1600, 950, [[["cRed","XXX"],["cWhite"," - ФЕДЕРАЛЬНЫЕ"]]
        ...
        add_text_to_gui(1550, 230, [[["cWhite","Основания на обыск автомобиля", "U"]]
                                   ...
                                   ,[["cWhite","► функции рыболовного надзора при отсутвии лицензии"]]
                                   ,[["cWhite","► функции охотничьего надзора при отсутвии лицензии"]]
