...
build_gui_2() {
    ...
    lc := ["Дорожный Кодекс"
        ,""
        ,[["2.",["Нарушении 3 статей ДК или неуплата штрафа"],"Изъятие","Д"]
        ,["3.",["Отсутствие лицензии на вождение (при отказе => 17.6)"],"до 1 000 $","Д"]
        ,["4.",["Неостановка по требованию"],"до 4 000 $","Д"]
        ,["9.",["Управление в сост. алк. оп."],"до 5 000 $","Д"]
        ,["9.1",["Управление в сост. нарк. оп."],"до 5 000 $","Д"]
        ,["11.",["Пересечение или занятие места в колонне"],"до 4 000 $","Д"]
        ,["14.",["Опасное вождение (►не уступил при перестроении (подрезание);►небезопасная дист.;"
        ,"►резкое торможение;►препятствование обгону;►нарушении сразу двух и более статей ДК.)"],"до 4 000 $","Д"]
        ,["16.",["Непропуск ТС со спец сигналами"],"до 3 000 $ или изъятие","Д"]
        ,["19.",["Беспорядочное движение пешехода на проезжей части"],"до 3 500 $","Д"]
        ,["29.",["Разворот в тоннелях, мостах, ж/д, переходах"],"до 4 000 $ или изъятие","Д"]
        ,["30.",["Встречка без разметки"],"до 2 000 $","Д"]
        ,["31.",["Встречка с разметкой"],"до 2 000 $","Д"]
        ,["33.",["Езда по обочинам/тротуарам/пешеходной зоне"],"до 5 000 $ или изъятие","Д"]
        ,["34.",["Превышение скорости:"
        ...
        ,"►штраф до 1 000 $ за превышение"
        ,"скорости на 10-25 км/ч;"
        ,"►штраф от 2 000 $ до 4 000 $ за"
        ,"превышение скорости на 26-40 км/ч;"
        ,"►штраф от 4 000 $ до 6 000 $ за"
        ,"превышение скорости на 41 и более км/ч."],"см. описание","Д"]
        ,["41.",["Парковка не в один ряд параллельно краю проезжей части. (мотики в два ряда)"],"до 3 000 $","Д"]
        ,["42.",["Остановка запрещается:"
        ,"►параллельно красному бордюру; ►на пешеходных переходах и тротуаре;"
        ,"►на ж/д переездах, трамвайных путях, мостах, в тоннелях; ►на перекрестках;"
        ,"►на крутых и опасных поворотах; ►на служебных стоянках государственных учреждений;"
        ,"►в специально обозначенных местах, указанных в подзаконных актах или указах."],"до 5 000 $","Д"]
        ,["48.",["Пересечение жёлтой двойной сплошной линии для обгона"],"до 3 000 $ или изъятие","Д"]
        ,["67.",["Несоответствие номерного знака с номерным знаком в техпаспорте."],"до 5 000 $ + изъятие","Д"]
        ,["68.",["Управление транспортным средством с нечитаемыми номерными знаками."],"до 3 500 $","Д"]
        ,["69.",["Управление транспортным средством с незарегистрированным номерным знаком или его отсутствием."],"до 5 000 $","Д"]
        ,["70.",["Смена номеров или сокрытие номерных знаков причастных к совершению преступления."],"до 4 000 $ + 16.14 УАК","Д"]]]
    add_law_chapter_to_gui(2, 10,150,lc)
