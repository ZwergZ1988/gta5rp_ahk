build_gui_1() {
  ...
  coord := Map()
  coord["FHD"] := {x:1160,y:200}
  coord["2K"] := {x:1160,y:200}
  add_text_to_gui_coord(myGui, coord, [
  ...
  add_text_to_gui(myGui, 900, 200,[
    ...
    {text:"- Очная ставка"},
    {text:"- Опознание"},
    {text:"- Освидетельствование"},
    {text:"- Проверка показаний"},
    {text:"- Производство судебной экспертизы"},
    {text:"- Контроль и запись переговоров"},
    {text:"- Следственный эксперимент"},
    {text:"- Возбуждение дела "},
    {text:"- Оперативно-розыскные мероприятия"},
    {text:"- Задержание"},    
  ])
  ...
  add_text_to_gui(myGui, 900, 5, [
    ...
    {text:"- задержание было произведено с нарушением ч. 2 ст. 13 ПК"},
    {text:"  (основания для задержания: застигнуто, 3 свид., видео и тд)"},
    {text:"- Прошло больше 1 часа с момента задержания "},
    {text:" c учетом замораживания сроков задержания в случаях: "},
    {text:"  проведения допроса;"},
    {text:"  вызова и разбирательства с адвокатом;"},
    {text:"  вызова и разбирательства с прок. и (или) руков"},
    {text:"  при обыске имущества задержанного."},
  ])
  ...
  offsetY := add_text_to_gui(myGui, 1400, coordY, [
    ...
    {text:" или реш. суда"},
    {text:"► ориентировка на лицо или трансп."},
    {text:"► 3 свидетеля"},
    ...
    {text:""},
    {text:"Задержание гос.сл только по главам УАК СА:"},
    {text:"6, 7, 8, 12, 13, 14, 15, 16, 17"},    
    {text:""},
