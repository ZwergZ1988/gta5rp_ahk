get_DK() {
  akt_name := "Дорожный Кодекс штата Сан-Андреас (от 13.10.2023)"
...
;  glava.zakony.push(zakon)
  ...
  zakon := {
    nomer: "Статья 6.",
    stro4ki: ["Наказание: В случае отсутствия лицензии на управление транспортом, предусмотрен штраф до $3'000, либо 3 месяц лишения свободы. Отказ от предоставления документов влечет за собой административную ответственность в соответствии со ст. 17.6 УАК.При аварии, водитель обязан остановиться и не трогаться с места. Также водитель не должен трогать и перемещать предметы, связанные с происшествием"],
  ...
  zakon := {
    ...
    nakazanie: "Выплата компенсации за причиненный ущерб возлагаются на виновника аварии."
  }
  glava.zakony.push(zakon)


;8.1 Водители, по обоюдному согласию, могут договориться о вине каждого из участников аварии и о сумме выплат за причиненный ущерб виновником аварии.
;8.2 Если водители не договорились о вине каждого из участников в аварии, то участники аварии должны вызвать на место уполномоченные правоохранительные органы, либо приехать в местный департамент правоохранительной службы, предварительно зафиксировав средствами фотосъемки расположение автомобилей друг к другу во время аварии.
;Наказание: За нарушение процедур, описанных в статьях 8, 8.1, 8.2 - штраф до $1.200.
...
;9.1 Водителю запрещается управлять транспортным средством в состоянии наркотического опьянении, вне зависимости от легального статуса наркотического вещества.
;Наказание: Штраф до $5.000, а также 4 месяца лишения свободы с изъятием наркотиков.

;9.2 Водителю запрещается употреблять алкогольные или наркотические вещества после аварии, к которой он причастен, либо после того, как автомобиль был остановлен по требованию сотрудника правоохранительных органов.
;Наказание: Штраф до $3.500, либо 2 месяца лишения свободы.
...
;14.1 Водитель и пассажиры обязаны пристегнуть ремень безопасности до начала движения транспортного средства и оставаться пристегнутыми до полной остановки транспортного средства.
...
glava := {name: glava_name, zakony: []}
  ...
  zakon := {
    nomer: "Статья 15.",
    stro4ki: ["Водители транспортного средства с включенным маячком синего, красного цвета или включенной сиреной могут отступать от требований Дорожного Кодекса, при условии обеспечения безопасности движения и нанесении минимального урона окружению."],
...
;16.1 Если два или более спецтранспорта с включенными проблесковыми маячками встретились на дороге, приоритет имеет транспорт медицинских служб скорой помощи EMS с включенным проблесковым маячком и включенной сиреной.
;Наказание: Штраф до $1.500 с водителя спецтранспорта не пропустившего автомобиль скорой помощи EMS.
...
;28.1 На нерегулируемых перекрестках, дорогу должен уступить водитель, к которому, транспортное средство приближается справа
;Наказание: Штраф до $900.
  ...
  zakon := {
    ...
    nakazanie: "Наказание: Штраф до $8.000."
  }
  glava.zakony.push(zakon)
  ...
  glava := {name: glava_name, zakony: []}
    ...
    nakazanie: "Наказание: $1.000 10-25 км/ч; $2.000-$4.000 26-40 км/ч; $4.000-$6.000 41 и более км/ч."
  }
  glava.zakony.push(zakon)
  ...
  glava_name := "Глава IV. Обязанности пешеходаГлава IX. Обгон и опережение"
  ...
  zakon := {
    ...
    nakazanie: "Наказание: Штраф до $4.000."
  }
  glava.zakony.push(zakon)
  ...
  zakon := {
    nomer: "Статья 42.",
    stro4ki: [
      "Остановка и парковка запрещается:",
      "⁃ параллельно красному бордюру;",
      "⁃ на газонах и других участках с зелеными насаждениями;",
      "⁃ на трамвайных путях, полосах торможения и разгона, тротуарах, местах движения пешеходов;",
      ...
      "- запрещена остановка у желтой линии, исключение вы можете остановиться рядом, чтобы загрузить или выгрузить предметы из вашего автомобиля, но не более 5 мин и не создавая помех движению другим транспортным средствам.",
      "- запрещено парковаться на местах обозначенных специальной разметкой как парковка для инвалидов.",
      "Исключение: Наличие мед.справки с пометкой “S”.",
      "Исключение: Транспортное средство с включенным проблесковым маячком синего и/или красного цвета и/или включенной сиреной.",
      "Исключение: На усмотрение руководства сотрудникам разрешено оставлять свой личный транспорт на служебных стоянках государственной организации, в которой они состоят.",
      "Исключение: Владельцы домов могут парковать своё транспортное средство около своего дома даже если оно перекрывает выезд/въезд в гараж.      ",
      ],
    nakazanie: "Наказание: Штраф до $5.000."
  }
  glava.zakony.push(zakon)
  ...
  zakon := {
    nomer: "Статья 49.",
    stro4ki: [
      "Одиночная желтая сплошная линия предупреждает о встречном движении, совершать обгон запрещено. Совершать разворот и поворот для въезда/выезда с прилегающей территории или дворов - разрешается, убедившись в безопасности такого маневра.",
  ...
  zakon := {
    nomer: "Статья 50.",
    stro4ki: [
      "Белая сплошная линия у правого края дороги обозначает край проезжей части и начало обочины – пересекать такую разметку разрешено.",
  ...
  zakon := {
    nomer: "Статья 53.",
    stro4ki: [
      "Стоп-линия указывает место где нужно остановиться для того чтобы пропустить движущийся транспорт на перекрёстке, если транспорта нет, то следует снизить скорость и притормозить.",
  ...
  zakon := {
    nomer: "Статья 54.",
    stro4ki: [
      "Требуется останавливаться перед пешеходным переходом, если пешеходы пересекают дорогу.",
  ...
  zakon := {
    nomer: "Статья 57.",
    stro4ki: [
      "Разметка надписями No Parking и Keep Clear запрещает постановку любого транспорта в пределах разметки, кроме транспорта экстренных служб.",
  ...
  zakon := {
    nomer: "Статья 63.",
    stro4ki: [
      "Знак запрещает дальнейшее движение.",
  ...
  zakon := {
    nomer: "Статья 66.",
    stro4ki: [
      "Знак предписывает двигаться по правой стороне относительно знака.",
