get_shpora_yk() {
  shpora_yk := [
    ...
    {nomer: "10.4", text: "Ограбление", nakaz: "6 лет", color: "cRed"},
    ...
    {nomer: "13.4", text: "неприемлемы вид", nakaz: "до 30 сут / до 3000", color: "cYellow"},
    ...
    {nomer: "17.3", text: "осткорбление госника", nakaz: "30 сут / 3000-5000", color: "cYellow"},
    {nomer: "17.4", text: "воспр. проф деятельности госника", nakaz: "20-40 сут", color: "cYellow"},
    {nomer: "17.6", text: "неповиновение законному требованию", nakaz: "до 40 сут / 5000", color: "cYellow"},
...
get_YK() {
  ...
  akt_name := "УГОЛОВНО-АДМИНИСТРАТИВНЫЙ КОДЕКС ШТАТА САН-АНДРЕАС (от 23.04.2023)"
  ...
  zakon := {
    ...
    "- Регионально-Федеральные [Р/Ф] и финансовые [Э] статьи влекут за собой запрет на работу в государственных учреждениях/организациях на 30 лет (( 30 ООС дней )), кроме статей, описанных в статье 5.4 настоящего кодекса.",
  ...
  zakon := {
    ...
    nakazanie: "→ 6 лет лишения свободы в Федеральной тюрьме или штраф в размере 35.000$."
  }
  glava.zakony.push(zakon)
  ...
  zakon := {
    ...
    tip: "[Р/Ф]",
    stro4ki: [
    "Cовершение лицом нескольких действий, содержащих составы административных правонарушений, ответственность за которые предусмотрена двумя и более статьями Административного кодекса.",
