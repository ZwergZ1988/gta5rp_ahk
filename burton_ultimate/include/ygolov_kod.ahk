get_shpora_yk() {
  shpora_yk := [
    {nomer: "10.1", text: "Кража", nakaz: "до 40 сут / 4000", color: "cYellow"},
    {nomer: "10.4", text: "Разбой", nakaz: "6 лет", color: "cRed"},
    {nomer: "10.5", text: "угон", nakaz: "до 40 сут / 5000", color: "cYellow"},
    {nomer: "12.6", text: "Хулиганство", nakaz: "до 40 сут / до 3000", color: "cYellow"},
    {nomer: "12.7", text: "протикновение на охр.", nakaz: "до 40 сут / до 5000", color: "cYellow"},
    {nomer: "12.8", text: "хранение оружия / броник в гос.уч", nakaz: "3-8 лет и лишение лиц", color: "cRed"},
    {nomer: "13.1", text: "нарк (>5гр кос / >8гр кос М / спанк)", nakaz: "до 40 сут", color: "cYellow"},
    {nomer: "13.2", text: "нарк (>10гр кос / >3 спанк)", nakaz: "5 лет", color: "cRed"},
    {nomer: "13.2.1", text: "нарк (>35гр кос / >5 спанк)", nakaz: "8 лет", color: "cRed"},
    {nomer: "13.4", text: "неприемлемы вид", nakaz: "до 5000", color: "cYellow"},
    {nomer: "15.1", text: "превышение должн полн", nakaz: "6 лет", color: "cRed"},
    {nomer: "15.1.1", text: "злоупотребление", nakaz: "4 года", color: "cRed"},
    {nomer: "15.4", text: "получение взятки", nakaz: "5 лет", color: "cRed"},
    {nomer: "15.5", text: "дача/попытка взятки", nakaz: "3 года", color: "cRed"},
    {nomer: "15.6", text: "халатность", nakaz: "3-6 лет", color: "cRed"},
    {nomer: "16.16", text: "вмешательство в процесс", nakaz: "до 20 / 5000", color: "cYellow"},
    {nomer: "16.17", text: "вмешательство госника в процесс ", nakaz: "до 3 лет", color: "cRed"},
    {nomer: "17.1", text: "посягательсво на жизнь госника", nakaz: "6-10 лет", color: "cRed"},
    {nomer: "17.2", text: "насилие с ущербом здоровью госника", nakaz: "3 года", color: "cRed"},
    {nomer: "17.3", text: "осткорбление госника", nakaz: "30 сут / 5000-9000", color: "cYellow"},
    {nomer: "17.4", text: "воспр. проф деятельности госника", nakaz: "20-40 сут", color: "cYellow"},
    {nomer: "17.6", text: "неповиновение законному требованию", nakaz: "до 40 сут / 10000", color: "cYellow"},
    {nomer: "17.7", text: "отказ от оплаты штрафа (2 мин)", nakaz: "20-40 сут", color: "cYellow"},
  ]
  return shpora_yk
}
...
get_YK() {
  ...
  akt_name := "УГОЛОВНО-АДМИНИСТРАТИВНЫЙ КОДЕКС ШТАТА САН-АНДРЕАС (от 13.10.2023)"
  ...
  zakon := {
    nomer: "1.1",
    stro4ki: ["Преступлением признается виновно совершенное общественно опасное деяние (противоправное, осознанное, волевое, действие или бездействие, нарушающее или создавшее реальную угрозу нарушения общественных отношений, охраняемых Уголовным законодательством), запрещенное настоящим Кодексом под угрозой",
    " наказания."]
  }
  glava.zakony.push(zakon)
  ...
  zakon := {
    ...
    stro4ki: [
      ...
      "ч. 1 К преступлениям небольшой тяжести относятся преступления, предусмотренные статьями 6.2, 7.4, 13.2, 16.6, 17.2, 17.5, 17.9, 18.1, 18.2 настоящего кодекса.",
      "ч. 2 К преступлениям средней тяжести относятся преступления, предусмотренные: 6.5, 8.1, 8.2, 8.3, 9.3, 10.3, 10.6, 11.1, 11.3, 11.4, 11.10, 11.11,11.12, 12.7.2, 15.1, 15.1.1, 15.2, 15.4, 15.5, 15.6, 16.1.1, 16.1.2, 16.7, 16.10, 16.11, 16.13, 16.15, 16.17, 18.4, 18.5, 18.7, 18.8 настоящего кодекса.",
      "ч. 3 К тяжким преступлениям относятся преступления, предусмотренные статьями настоящего кодекса: 6.3, 7.1, 10.4, 11.2, 11.6, 11.7, 12.8, 12.9, 12.10, 12.10.1, 13.2.1, 13.5, 14.1, 14.3, 14.5, 15.7, 16.1, 16.4, 16.5, 16.8, 16.12, 16.14, 17.1, 18.3, 18.6 настоящего кодекса.",
      "ч. 4 К особо тяжким преступлениям относятся преступления, предусмотренные статьями: 6.4, 12.1, 12.2, 12.3, 12.5, 12.12, 14.2, 14.4, 14.6, 16.2 настоящего кодекса.",
      ]
  }
  glava.zakony.push(zakon)
  ...
  zakon := {
    nomer: "3.1",
    stro4ki: ["Не является преступлением причинение вреда посягающему лицу в состоянии необходимой обороны, при защите личности и прав обороняющегося или других лиц, если это посягательство было сопряжено с насилием, опасным для жизни обороняющегося или другого лица, либо с непосредственной угрозой ",
  ...
  zakon := {
    nomer: "3.3",
    stro4ki: ["Не является преступлением причинение вреда лицу, совершившему преступление, при его задержании для доставления органам власти, если иными средствами задержать такое лицо не представлялось возможным и при этом не было допущено превышения необходимых для этого мер (когда лицу без необходимости ",
  ...
  zakon := {
    nomer: "3.4",
    stro4ki: ["Не является преступлением причинение вреда в состоянии крайней необходимости, то есть для устранения опасности, непосредственно угрожающей личности и правам данного лица или иных лиц, если эта опасность не могла быть устранена иными средствами и при этом, не было допущено превышения пределов ",
    "крайней необходимости, явно не соответствующего характеру и степени угрожавшей опасности и обстоятельствам."]
  }
  glava.zakony.push(zakon)
  ...
  zakon := {
    ...
    "незаконного приказа или распоряжения, несет уголовную ответственность на общих основаниях. Неисполнение заведомо незаконного приказа или распоряжения исключает уголовную ответственность)."]
  }
  glava.zakony.push(zakon)
  ...
  zakon := {
    ...
    stro4ki: [
      ...
      "г) Лишение определенных прав, званий, наград и привилегий;",
      "д) Принудительные работы;",
      "е) Лишение или ограничение свободы, представляющее собой заключение в федеральной тюрьме, следственном изоляторе или КПЗ;",
      "ё) Пожизненное лишение свободы.",
      ]
  }
  glava.zakony.push(zakon)
  ...
  zakon := {
    nomer: "4.5.1",
    stro4ki: ["Лицо, совершившее преступление, может быть освобождено судом от реального отбывания наказания с назначением условного осуждения (испытательного срока). Если в течение испытательного срока, установленного судом, осужденный уклоняется от контроля и исполнения возложенных на него обязанностей, нарушает положения ",
    "условного наказания, назначенные судом, , совершает правонарушение и/или преступление, условное осуждение может быть отменено судом, после чего, назначенное наказание за нарушение положения условного срока вступит в силу. По окончании испытательного срока или, если до истечения испытательного срока условно осужденный своим поведением доказал свое исправление, ограничения с осужденного снимаются, судимость погашается, по решению суда . Данное наказание не может быть назначено лицу, признанному судом виновным за совершение особо тяжкого преступления."]
  }
  glava.zakony.push(zakon)

  zakon := {
    nomer: "4.5.2",
    stro4ki: ["Судебный штраф может быть назначен судом как альтернатива лишению свободы, так и вместе с лишением свободы. Сумма судебного штрафа выявляется и назначается судом, учитывая степень и характер правонарушения и/или преступления. Данное наказание не может быть назначено как альтернатива лишению свободы лицу, ",
    "признанному судом виновным в совершении особо тяжкого преступления."]
  }
  glava.zakony.push(zakon)
  ...
  zakon := {
    nomer: "4.5.3",
    stro4ki: [
      "По итогам судебного процесса, по решению суда, гражданин может быть лишен права занимать определенные должности и заниматься определенной работой.",
      "Пример №1: Осужденный за злоупотребление полномочиями, не может работать на должности, дающей человеку превосходящие полномочия обычного гражданина, до снятия судом данного ограничения.",
      "Пример №2: Осужденный за Браконьерство не может заниматься законным выловом рыбы или охотничьей деятельностью, до снятия судом данного ограничения.",
      "Примечание: Для снятия ограничений деятельности гражданину требуется подать Заявление в верховный суд с названием “Заявление на снятие ограничений №ххх”. В ходе рассмотрения заявления, суд может вынести как положительный ответ, так и отрицательный, в зависимости от личного мнения судьи. Заявления на снятие ограничений ",
      "можно подавать не чаще чем раз в 5 дней.      ",
      ]
  }
  glava.zakony.push(zakon)
  ...
  zakon := {
    nomer: "4.5.4",
    stro4ki: ["Лишение определенных прав (изъятие лицензий на оружие, вождение, рыбалку, охоту, адвокатскую деятельность; лишение права занимать определенные должности, заниматься определенной деятельностью), званий, наград и привилегий может быть назначено судом как альтернатива лишению свободы, так и вместе с лишением свободы. ",
    "Данное наказание не может быть назначено как альтернатива лишению свободы лицу, признанному судом виновным в совершении особо тяжкого преступления."]
  }
  glava.zakony.push(zakon)
  ...
  zakon := {
    nomer: "4.5.5",
    stro4ki: [
      "Принудительные работы могут быть назначены судом как альтернатива лишению свободы. Принудительные работы заключаются в выполнении лицом, совершившим правонарушение и/или преступление, работы, установленной судебным решением. Из заработной платы осужденного, получаемой за выполнение принудительных работ, ",
      "производятся удержания в размере, установленном решением суда, в доход государства, перечисляемые на счет казны Government. Судом может быть назначен любой вид принудительных работ на свое усмотрение.",
      "Примечание: данное наказание не может быть назначено как альтернатива лишению свободы лицу, признанному судом виновным в совершении особо тяжкого преступления.",
      ]
  }
  glava.zakony.push(zakon)
  ...
  zakon := {
    nomer: "4.5.6",
    stro4ki: [
      "Если, назначив исправительные работы, или лишение свободы на срок до восьми лет, суд придет к выводу о возможности исправления осужденного без реального отбывания наказания, он постановляет считать назначенное наказание условным.",
      "ч. 1 Условное осуждение не назначается в следующих случаях:",
      "а) Осужденным за преступления против половой неприкосновенности.",
      "б) Осужденным за преступления, предусмотренные статьями: 6.3, 6.4, 7.1, 8.1, 8.2, 12.1,12.2, 12.3, 14.2, 14.4, 14.6 настоящего кодекса.",
      ...
      "ч. 2 При назначении условного осуждения суд учитывает характер и степень общественной опасности совершенного преступления, личность виновного, в том числе смягчающие и отягчающие обстоятельства.",
      "ч. 3 При назначении условного осуждения суд устанавливает испытательный срок, в течение которого условно осужденный должен своим поведением доказать свое исправление. В случае назначения лишения свободы на срок до шести лет или более мягкого вида наказания, испытательный срок должен быть не менее трех лет (( 3 дней ))",
      " и не более семи лет (( 7 дней )), а в случае назначения лишения свободы на срок свыше шести лет включительно — не менее восьми лет (( 8 дней )) и не более двенадцати лет (( 12 дней )). Испытательный срок исчисляется с момента вступления приговора в законную силу. В испытательный срок засчитывается время, прошедшее со дня провозглашения приговора.",
      "ч. 4 При условном осуждении также могут быть назначены дополнительные виды наказаний.",
      "ч. 5 Суд, назначая условное осуждение, возлагает на условно осужденного с учетом его возраста, трудоспособности и состояния здоровья исполнение определенных обязанностей: не менять постоянного места жительства, работы, без уведомления специализированного государственного органа, осуществляющего контроль",
      " за поведением условно осужденного, пройти курс лечения от алкоголизма, наркомании, токсикомании или венерического заболевания, трудиться (трудоустроиться) либо продолжить обучение в общеобразовательной организации. Суд может возложить на условно осужденного исполнение и других обязанностей, способствующих его исправлению.",
      "Суд может возложить на условно осужденного исполнение и других обязанностей, способствующих его исправлению.",
      "ч. 6 Контроль за поведением условно осужденного осуществляется уполномоченным на то специализированным государственным органом, назначенным судом.",
      "ч. 7 В течение испытательного срока суд по представлению органа, осуществляющего контроль за поведением условно осужденного, может отменить полностью или частично либо дополнить ранее установленные для условно осужденного обязанности.      ",
      ]
  }
  glava.zakony.push(zakon)
...
zakon := {
    nomer: "4.6",
    stro4ki: ["При нарушении двух и более административных статей УАК, предусматривающих арест, лицо, признанное виновным в совершении преступления, может быть привлечено к уголовной ответственности сроком до 3 лет."]
  }
  glava.zakony.push(zakon)
  ...
  zakon := {
    nomer: "4.8",
    stro4ki: ["Штрафы, предусмотренные статьями настоящего Кодекса, взыскиваются сотрудником государственной структуры, применившим данную меру наказания, а также в судебном порядке или сотрудниками Офиса Генерального Прокурора на основании делопроизводства."]
  }
  glava.zakony.push(zakon)
  ...
  zakon := {
    ...
    stro4ki: [
      ...
      "Примечание: Лицо не может быть освобождено от уголовной ответственности по статье 5.2 УАК в случае нарушения статей Главы 6: 6.3, 6.4; Главы 7: 7.1; Главы 8; Главы 10: 10.1, 10.2, 10.3, 10.4; Главы 12: 12.1, 12.2, 12.3, 12.5; Главы 13: 13.2, 13.2.1, 13.5; Главы 14; Главы 15: 15.1, 15.1.1, 15.4, 15.5; ",
      "Главы 17: 17.1, 17.2, 17.5, 17.8.",
      "Примечание: В случае, если сотрудник Офиса Генерального Прокурора принял решение о назначении штрафной санкции, он обязан опубликовать необходимые предписания/постановления на официальном портале штата.",
  ...
  zakon := {
    ...
    stro4ki: [
      ...
      "ч. 3 Федеральные [Ф], а также статьи описанные в статье 5.4 настоящего Кодекса, влекут за собой пожизненный запрет на работу, службу в государственных учреждениях, организациях.",
      "Примечание: Срок запрета исчисляется с момента отбытия наказания. Запрещено принимать на работу людей с действующими статьями которые накладывают запрет на работу в государственных структурах.      ",
      ]
  }
  glava.zakony.push(zakon)
...
zakon := {
  ...
  tip: "[А]",
  stro4ki: [
    "Нарушение против личности, деловой репутации и оскорбления сотрудниками представительства Средств Массовой информации, равно нарушение законодательства об журналистской деятельности.",
...
zakon := {
  ...
  tip: "[Р/Э]",
  stro4ki: [
    "Организация, проведение и участие в азартных играх в общественных местах.",
    "Исключение: Казино",
    ],
  nakazanie: "- 6 лет лишения свободы в Федеральной тюрьме."
}
...
zakon := {
  ...
  stro4ki: [
    ...
    "Исключение: Предназначенными для осуществления торговли, общественными местами, являются Амфитеатр(Рынок Б/У автомобилей) и палаточные рынки, находящиеся на пляже Vespucci, Палето Бей, Сенди Шорс.",
    ],
  nakazanie: "- до 40 суток ограничения свободы в КПЗ, либо штраф 5.000$."
}
glava.zakony.push(zakon)
...
zakon := {
  ...
  nomer: "11.11",
  tip: "[Ф]",
  stro4ki: ["Распространение журналистом рекламы или сведений об организации или группе лиц, которая не зарегистрирована в установленном Законом о предпринимательской деятельности порядке, а равно в отсутствии у организации или группы лиц лицензии, либо в условиях аннулирования или приостановления лицензии ",
  "на предпринимательскую деятельность у организации или группы лиц."],
...
zakon := {
  ...
  nomer: "12.1",
  tip: "[Ф]",
  stro4ki: ["Терроризм, то есть совершение взрыва, поджога или иных действий, устрашающих население и создающих опасность гибели человека, причинения значительного имущественного ущерба либо наступления иных тяжких последствий, в целях дестабилизации деятельности органов власти или международных организаций либо воздействия ",
  "на принятие ими решений, а также угроза совершения указанных действий в целях воздействия на принятие решений органами власти."],
  nakazanie: "- 12 лет лишения свободы в Федеральной тюрьме.."
}
glava.zakony.push(zakon)
...
zakon := {
  ...
  tip: "[А]",
  stro4ki: [
    "Хулиганство, то есть неоднократное нарушение общественного порядка, выражающее явное неуважение к обществу, нарушение правил поведения в учреждениях, организациях, а равно неоднократное и злостное мелкое хулиганство (см. комментарий к ст. 12.6).",
    ...
    "д) Курить сигареты/кальян/бонг и использовать вейп в помещениях учреждения и на его территории;",
...
zakon := {
  ...
  tip: "[А]",
  stro4ki: [
    "Незаконное проникновение (нахождение) на охраняемый в соответствии с законодательством Штата Сан-Андреас объект",
    "Комментарий к статье 12.7:",
    "ч. 1 Охраняемыми объектами являются следующие:",
    "а) Участки LSPD, LSSD и служебные парковки, кроме территории холла.",
    "б) Офис FIB и служебные парковки, кроме территории холла.",
    "в) Капитолий Штата Сан-Андреас, кроме территории холла.",
    "г) Здания медицинских учреждений и служебные парковки, кроме территории холла.",
    "д) Государственное химическое предприятие Humane Labs.",
    "ч. 2 Запрещен полный доступ всем, кроме:",
    "а) Участки LSPD, LSSD и служебные парковки, кроме территории холла. Имеют доступ: Губернатор, Вице-Губернатор, Генеральный прокурор, его заместители и советники, сотрудники Офиса Генерального прокурора, иные сотрудники Правительства, согласно указу Губернатора штата Сан-Андреас, сотрудники ",
    "правоохранительных структур во время проведения процессуальных действий (исключение - сотрудники LSPD на территории участка LSPD, сотрудник LSSD на территории участка LSSD), частные и государственные адвокаты, (исключение - служебные парковки), сотрудники Экстренной Медицинской Службы во время",
    " осуществления первой медицинской помощи при поступлении вызова, судьи по запросу любого из субъектов задержания для дачи разъяснения либо толкования законодательства и решения спорных аспектов задержания. Умозаключение судьи имеет рекомендательный характер.",
    ...
    "б) Офис FIB и служебные парковки, кроме территории холла. Имеют доступ: Губернатор, Вице-Губернатор, Генеральный прокурор Штата Сан-Андреас, его заместители, иные сотрудники Правительства, согласно указу Губернатора штата Сан-Андреас, сотрудники FIB, сотрудники Экстренной Медицинской Службы ",
    "во время осуществления первой медицинской помощи при поступлении вызова.",
    "в) Капитолий Штата Сан-Андреас, кроме территории холла. Имеют доступ: сотрудники Правительства Штата Сан-Андреас, Судьи, сотрудники Экстренной Медицинской Службы во время осуществления первой медицинской помощи при поступлении вызова.",
    "г) Здания медицинских учреждений и служебные парковки, кроме территории холла. Имеют доступ: Губернатор, Вице-Губернатор, иные сотрудники Правительства, согласно указу Губернатора штата Сан-Андреас, сотрудники Офиса Генерального прокурора, сотрудники правоохранительных структур во время проведения",
    " процессуальных действий, сотрудники Экстренной Медицинской Службы.",
    "д) Государственное химическое предприятие Humane Labs. Имеют доступ: Губернатор, Вице-губернатор, иные сотрудники Правительства, согласно указу Губернатора штата Сан-Андреас, сотрудники правоохранительных структур во время проведения процессуальных действий, сотрудники Экстренной Медициской Службы ",
    "во время осуществления первой медицинской помощи при поступлении вызова.",
    ],
...
zakon := {
  ...
  tip: "[А]",
  stro4ki: [
    "Незаконное проникновение (нахождение) на частную территорию, объект. (см. комментарий к ст. 12.7.1)",
    ...
    "Исключение: Доступ может быть получен при наличии соответствующего ордера от Генерального прокурора Штата Сан-Андреас, Вице-Губернатора, Губернатора или Верховного Судьи. Доступ иных лиц на охраняемые объекты возможен исключительно при сопровождении лиц, имеющих право доступа к ним.    ",
    ],
  nakazanie: "- от 10 до 30 суток лишения свободы либо штраф до 5.000$."
}
glava.zakony.push(zakon)
...
zakon := {
  ...
  tip: "[Р/Ф]",
  stro4ki: [
    "Незаконное проникновение (нахождение) на особо охраняемый объект в соответствии с законодательством штата Сан-Андреас,",
    "Комментарий к статье 12.7.2:",
    "ч. 1 Особо охраняемыми объектами являются следующие:",
    "а) ВПП, ангары аэропорта и прилегающие территории",
    "б) Федеральная тюрьма Bolingbroke и ее воздушное пространство",
    "Исключение: Сотрудники FIB вправе въезжать на территорию федеральной тюрьмы по запросу уполномоченных сотрудников для проведения ареста сроком более чем 6 лет.",
    "в) Форт Занкудо и его воздушное пространство;",
    "г) Авианосец USS Luxington и его воздушное пространство;",
    "д) Дополнительные объекты, указанные в нормативно-правовых актах",
    "ч. 2 Запрещен полный доступ всем, кроме:",
    "а) ВПП, ангары аэропорта и прилегающие территории. Имеют доступ: сотрудники USSS, сотрудники Правительства, сотрудники силовых структур для выполнения служебных заданий. Медики для оказания первой помощи.",
    "б) Форт Занкудо. Имеют доступ: военнослужащие Национальной Гвардии Штата, Губернатор, Вице-Губернатор, Генеральный прокурор и его заместители, иные сотрудники Правительства, согласно указу Губернатора штата Сан-Андреас сотрудники государственных структур во время специальных операцией по защите интересов национальной ",
    "безопасности. Другие граждане в сопровождении генералитета или при наличии пропуска, выданного генералитетом Национальной Гвардии в соответствии с внутренним регламентом.",
    "в) Авианосец. Имеют доступ: военнослужащие Национальной Гвардии Штата, Губернатор, Вице-Губернатор, иные сотрудники Правительства, согласно указу Губернатора штата Сан-Андреас. Другие граждане в сопровождении генералитета или при наличии пропуска, выданного генералитетом Национальной Гвардии в соответствии с внутренним",
    " регламентом.",
    "г) Вся территория Федеральной Тюрьмы, кроме гостевой парковки и холла тюрьмы. Имеют доступ: сотрудники SASPA. Сотрудники LSPD, USSS, NG, LSSD, FIB при исполнении своих должностных обязанностей. EMS для оказания медицинской помощи или по вызову сотрудниками федеральной тюрьмы. Губернатор, Вице-Губернатор, иные сотрудники ",
    "Правительства, согласно указу Губернатора штата Сан-Андреас, Генеральный прокурор, его заместители, сотрудники Офиса Генерального прокурора, государственные адвокаты, руководство сотрудников правоохранительных структур в случае задержания их подчиненных по вызову сотрудников, производящих процесс задержания, ",
    "частные адвокаты по вызову задержанного с целью реализации его прав во время задержания, судьи по запросу любого из субъектов задержания для дачи разъяснения либо толкования законодательства и решения спорных аспектов задержания. Умозаключение судьи имеет рекомендательный характер.",
    ],
  nakazanie: "- 5 лет лишения свободы в Федеральной Тюрьме."
}
glava.zakony.push(zakon)
...
zakon := {
  ...
  tip: "[Р/Ф]",
  stro4ki: [
    "Незаконные приобретение, передача, сбыт, хранение, перевозка или ношение любых видов оружия/боеприпасов, спец. средств государственного образца, открытое ношение бронежилета не государственного образца на территории госучреждений, а также иное нарушение закона “о Регулировании оборота оружия боеприпасов и спецсредств",
    " в штате Сан-Андреас”.",
...
zakon := {
  ...
  nomer: "12.12",
  tip: "[Ф]",
  stro4ki: ["Создание преступного сообщества (преступной организации) в целях совершения одного или нескольких тяжких или особо тяжких преступлений либо руководство преступным сообществом (преступной организацией) или входящими в него (нее) структурными подразделениями, а равно координация действий организованных групп, ",
  "создание устойчивых связей между ними, разработка планов и создание условий для совершения преступлений организованными группами, раздел сфер преступного влияния и (или) преступных доходов между такими группами."],
...
zakon := {
  ...
  tip: "[А]",
  stro4ki: [
    "Нахождение в неприемлемом виде в общественных местах (( Зеленых зонах )) и местах большого скопления людей свыше семи человек, а также на закрытых и охраняемых территориях. (см. комментарий к ст. 13.4)",
    ...
    "б) Нахождение в маске, для гражданских лиц. Исключение: Высокопоставленное руководство государственных структур при исполнении служебных обязанностей. По первому требованию сотрудников государственных структур - лица попадающие под данный перечень обязаны предъявить опознавательный знак в случае если являются ",
    "засекреченной личностью, в ином случае снять маску и предъявить служебное удостоверение; ",
    ...
    "в) В состоянии опьянения, оскорбляющем человеческое достоинство, а также потребление (распитие) алкогольной продукции либо наркотических средств или психотропных веществ, новых потенциально опасных психоактивных веществ или одурманивающих веществ в общественных местах, равно как появление в алкогольном ",
    "или наркотическом опьянении Исключение: развлекательные, увеселительные учреждения (( клубы, бары, казино )).",
  ...
  nakazanie: "- штраф в размере до 5.000$."
}
glava.zakony.push(zakon)
...
zakon := {
  ...
  nomer: "13.6",
  tip: "[А]",
  stro4ki: ["Проституция, а именно предоставление, а равно предложение услуг сексуального характера."],
  nakazanie: "- От 20 до 40 суток ограничения свободы в КПЗ."
}
glava.zakony.push(zakon)
...
zakon := {
  ...
  nomer: "14.4",
  tip: "[Ф]",
  stro4ki: ["Подрыв национальной безопасности, а равно попытка подрыва либо призыв к подрыву национальной безопасности путем: выведения государственных средств в офшоры, спонсирования террористов или группу лиц которая замешана в гос. перевороте, продажа документов имеющие гриф секретно, уничтожение Государственных ",
  "документов которые имеют важность или подделка этих документов."],
  nakazanie: "- 12 лет лишения свободы в Федеральной тюрьме. По решению суда - пожизненное лишение свободы."
}
glava.zakony.push(zakon)
...
zakon := {
  ...
  nomer: "14.6",
  tip: "[Ф]",
  stro4ki: ["Государственная измена, то есть совершенные жителями штата шпионаж, выдача иностранному государству, международной либо иностранной организации или их дипломатическим представительствам сведений, составляющих государственную тайну, доверенную лицу или ставшую известной ему по службе, работе, либо ",
  "оказание финансовой, материально-технической, консультационной или иной помощи иностранному государству, международной либо иностранной организации или их дипломатическим представительствам в деятельности, направленной против безопасности штата."],
  nakazanie: "- 12 лет лишения свободы в Федеральной Тюрьме. По решению суда - пожизненное лишение свободы."
}
glava.zakony.push(zakon)
...
zakon := {
  ...
  nomer: "15.2",
  tip: "[Ф/Д]",
  stro4ki: ["Умышленное неисполнение сотрудником органов правопорядка приказа, распоряжения и иного нормативного-правового акта начальника или другого уполномоченного должностного лица, отданного в установленном порядке и не противоречащего закону, причинившее существенный вред правам и законным интересам граждан ",
  "или организаций, либо охраняемых законом интересов общества или государства."],
  nakazanie: "- от 4 до 6 лет лишения свободы в Федеральной тюрьме"
}
glava.zakony.push(zakon)
...
zakon := {
  ...
  nomer: "16.2",
  tip: "[Ф]",
  stro4ki: ["Угроза, а равно посягательство на жизнь судьи, или иного лица, участвующего в отправлении правосудия, прокурора, помощника прокурора, защитника, эксперта, специалиста, судебного пристава, судебного исполнителя, а равно их близких в связи с рассмотрением дел в суде, производством расследования ",
  "либо исполнением приговора, решения суда или иного судебного акта, совершенное в целях воспрепятствования законной деятельности указанных лиц, либо из мести за такую деятельность."],
  nakazanie: "- 4 года лишения свободы в Федеральной тюрьме."
}
glava.zakony.push(zakon)
...
zakon := {
  ...
  nakazanie: "- 4 лет лишения свободы в Федеральной тюрьме."
}
glava.zakony.push(zakon)
...
zakon := {
  ...
  nomer: "16.7",
  tip: "[Ф]",
  stro4ki: ["Фальсификация доказательств по уголовному делу лицом, производящим расследование, прокурором, помощником прокурора или защитником."],
  nakazanie: "- 6 лет лишения свободы в Федеральной тюрьме."
}
glava.zakony.push(zakon)
...
zakon := {
  ...
  stro4ki: [
    ...
    "Таковыми являются попытка скрыться при задержании или публикации ордера на арест, неявка на вызов сотрудника Офиса Генерального Прокурора или сотрудника правоохранительных органов уполномоченного вести следствие и задержание, а также по судебной повестке; смена фамилии и других идентификационных данных, ",
    "изменение своего внешнего вида при помощи пластической хирургии.",
    ],
  nakazanie: "- 6 лет лишения свободы в Федеральной тюрьме или штраф до 50.000$."
}
glava.zakony.push(zakon)
...
zakon := {
  ...
  nomer: "16.17",
  tip: "[Р/Ф]",
  stro4ki: ["Вмешательство или воспрепятствование процессу задержания или непосредственно аресту, а также процессу разбирательства, лицом являющимся государственным служащим с использованием своего служебного положения в государственной структуре. Исключения является вмешательство сотрудника Прокуратуры, ",
  "на законном основании нарушений процесса задержания, ареста или разбирательств, со стороны государственного служащего, проводящего задержание."],
  nakazanie: "- 3 года лишения свободы в Федеральной тюрьме."
}
glava.zakony.push(zakon)
...
zakon := {
  ...
  nomer: "17.3",
  tip: "[А]",
  stro4ki: ["Оскорбление представителя власти при исполнении им своих должностных обязанностей или в связи с их исполнением. Оскорбление заключается в негативной оценке личности, либо внешности человека, его качеств, поведения, причем в форме, противоречащей установленным правилам поведения и требованиям",
  " общечеловеческой морали, а также косвенное оскорбление представителей власти. ((Камень, клоун, мусор и т. п.))."],
  nakazanie: "- 30 суток ограничения свободы в КПЗ либо штраф от 5 000$ до 9 000$."
}
glava.zakony.push(zakon)
...
zakon := {
  ...
  tip: "[А]",
  stro4ki: [
    "Воспрепятствование профессиональной деятельности государственного служащего или провокация в отношении них выраженные в любой форме, при исполнении ими своих обязанностей, а равно воспрепятствование работе. (см. комментарий к ст. 17.4)",
...
zakon := {
  ...
  nakazanie: "- до 40 суток лишения свободы, либо штраф в размере до 10.000$."
}
glava.zakony.push(zakon)
...
zakon := {
  ...
  tip: "[Р/Ф]",
  stro4ki: [
    "Совершение лицом нескольких действий, содержащих составы административных правонарушений, ответственность за которые предусмотрена двумя и более статьями Уголовно-Административного кодекса.",
